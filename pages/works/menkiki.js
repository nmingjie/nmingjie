  ...
  <Layout title="Menkiki (麺利き)">
    <Container>
      ...
      <List ml={4} my={4}>
        ...
        <ListItem>
          <Meta>Presentation</Meta>
          <Link href="https://speakerdeck.com/mingjie/caffedeoshou-qing-ben-ge-deipuraninguiosapuri">
        ...
        <ListItem>
          <Meta>Source</Meta>
          <Link href="https://github.com/mingjie/caffe-ios-sample">
            github.com/mingjie/caffe-ios-sample <ExternalLinkIcon mx="2px" />
          </Link>
        </ListItem>
      </List>
