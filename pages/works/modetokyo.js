...
const Work = () => (
  <Layout title="mode.tokyo">
    <Container>
      ...
      <P>The mode magazine for understanding to personally enjoy Singapore.</P>
      <P>
        ...
        foreign high-intellect class to Singapore, who are highly interested in
        Singaporeese culture. I joined the project to build its mobile app for iOS
      ...
      <List ml={4} my={4}>
        ...
        <ListItem>
          ...
          <Link href="https://www.isid.co.jp/english/news/release/2015/pdf/20150930_ModeTokyo.pdf">
            ...
            on Visit of Foreign High-Intellect Class to Singapore{' '}
